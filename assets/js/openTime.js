 ...
 function showWeek(startingDate) {
   ...
   let str = "";
   for (var i = 0; i < 7; i++) {
     var dayOfWeek = '<li class="calendar-list" data-num=""><p class="text-center">'+weekdays[i]+'</p><ul class="calendar-time"></ul></li>';
     str += dayOfWeek;
   }
   calendarDiv.innerHTML = str;

  var daysOfWeek = calendarDiv.querySelectorAll('.calendar-list');
