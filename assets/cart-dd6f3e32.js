import{a as p,u as q,g as W,r as _}from"./backtotop-407cb22f.js";let r=[];const V=Swal.mixin({toast:!0,position:"top-end",showConfirmButton:!1,timer:1500}),v=document.querySelector("#coupon"),I=document.querySelector(".js-useCouponBtn");let h=[],y=[];const Q={myCouponId:"",originPrice:"",courseId:"",type:"",title:"",discount:0,minSpending:"",discountCourseNum:"",discountPrice:0};function w(){r=Array.from({length:u.length+1},()=>Q)}v.addEventListener("keydown",e=>{e.key==="Enter"&&(e.preventDefault(),E())});I.addEventListener("click",e=>{e.preventDefault(),E()});async function T(){try{for(const e of r)if(e.myCouponId){const t=`https://project-code-json-k0ti.onrender.com/myCoupons/${e.myCouponId}`,n={canUse:!1};await p.patch(t,n,b)}}catch(e){console.log("patchMyCoupon",e)}}async function R(){try{const e=`https://project-code-json-k0ti.onrender.com/myCoupons?_expand=coupon&userId=${q}&_sort=couponId&_order=asc`,{data:t}=await p.get(e);h=t,z()}catch(e){console.log("getCoupon",e)}}async function z(){const e=[];h.forEach(t=>{let n=new Date().getTime();new Date(t.dueDate).getTime()<n&&(t.canUse=!1,e.push(t))}),e.length>0&&(await Promise.all(e.map(async t=>{try{await p.patch(`https://project-code-json-k0ti.onrender.com/myCoupons/${t.id}`,{canUse:!1},b)}catch(n){console.log("checkDueDate",n)}})),h=h.filter(t=>t.canUse===!0)),N()}function N(){y=[],h.forEach(e=>{if(e.coupon.type==="allCourse"){const{courseId:t,type:n,title:o,minSpending:s,discountCourseNum:c,discount:i}=e.coupon,a={myCouponId:e.id,originPrice:null,courseId:t,type:n,title:o,discount:i,minSpending:s,discountCourseNum:c};y.push(a)}}),u.forEach(e=>{h.forEach(t=>{if(t.coupon.type==="course"&&e.courseId==t.coupon.courseId){const{courseId:n,type:o,title:s,discount:c,minSpending:i,discountCourseNum:a}=t.coupon,l=e.course.price;if(n==e.courseId){const d={myCouponId:t.id,originPrice:l,courseId:n,type:o,title:s,discount:c,minSpending:i,discountCourseNum:a};y.push(d)}}})}),Y()}function E(){const e=y.filter(t=>t.title===v.value)[0];if(e!==void 0){const t=document.querySelector("#OriginalPrice").textContent.replace(",",""),n=document.querySelectorAll("li[data-course]"),{minSpending:o,discountCourseNum:s,courseId:c}=e;if(V.fire({icon:"success",title:"已使用優惠券"}),o<=t)if(e.type==="course")n.forEach((i,a)=>{const l=i.dataset.course;if(c==l){const d=i.querySelector("input[name='count']");s===null||Number(s)<=Number(d.value)?r[a].myCouponId==""?(v.value="",B(a,e)):Swal.fire({icon:"error",title:"每個課程只能使用一張優惠券"}):Swal.fire({icon:"error",title:"未符合使用條件",text:`須購買指定課程達 ${s} 堂課`})}});else{const i=r.length-1;r[i].myCouponId==""?(v.value="",B(i,e)):Swal.fire({icon:"error",title:"每個課程只能使用一張優惠券"})}else Swal.fire({icon:"error",title:"未符合使用條件",text:`折價前的消費總額須達 NT$ ${o}`})}else Swal.fire({icon:"error",title:"沒有匹配的優惠券"});console.log(r)}function F(e){P(e),g()}function G(e,t){const n=document.querySelector("#OriginalPrice").textContent.replace(",","");r.forEach((o,s)=>{const{minSpending:c,discountCourseNum:i,courseId:a,myCouponId:l}=o;c<=n?a==e?i===null||i<=t?o.discountPrice=D(o):P(s):s==r.length-1&&l!==""&&(o.discountPrice=D(o)):P(s)}),g()}function P(e){r[e].myCouponId="",r[e].originPrice=0,r[e].courseId="",r[e].type="",r[e].title="",r[e].discount="",r[e].minSpending=0,r[e].discountCourseNum=0,r[e].discountPrice=0}function B(e,t){r[e]={...t,discountPrice:D(t)},g()}function D(e){const{type:t,originPrice:n,discount:o,discountCourseNum:s}=e;if(t==="course")return Math.round(Number(n)*(1-Number(o))*Number(s));{const c=document.querySelector("#OriginalPrice").textContent.replace(",","");return Math.round(Number(c)*(1-Number(o)))}}function O(e){r=r.filter(t=>t.courseId!=e)}const k=document.querySelector(".js-cartList"),J=document.querySelector(".js-nextCartList");function M(){let e="";u.length?u.forEach((t,n)=>{var o,s,c,i,a,l,d,m;e+=`
                ...
                >
                  <div class="text-center">
                    ...
                    <h5 class="fs-7 fs-md-6">
                      ${(a=(i=t.course)==null?void 0:i.teacher)==null?void 0:a.name}
                    </h5>
                  </div>
                </div>
      ...
      `,k.innerHTML=e,K()}function K(){const e=document.querySelector("#payWay");u.length?(e.querySelectorAll("button").forEach(t=>{t.disabled=!1}),I.disabled=!1):(e.querySelectorAll("button").forEach(t=>{t.disabled=!0}),I.disabled=!0)}function H(){let e="";f.length?f.forEach((t,n)=>{var o,s,c,i,a,l,d,m;e+=`
      <li data-course="${t.courseId}">
              <div
                class="shadow rounded-2 p-4 pb-md-4 pt-md-6 px-md-8 mb-1 mb-md-2"
              >
                ...
                <div class="row justify-content-between">
                  ...
                  >
                    <div class="text-center">
                      ...
                      <h5 class="fs-7 fs-md-6">${(a=(i=t.course)==null?void 0:i.teacher)==null?void 0:a.name}</h5>
                    </div>
                  </div>
