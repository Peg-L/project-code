import"./backtotop-7745fe90.js";const l=JSON.parse(sessionStorage.getItem("appointment")),n=document.querySelector(".js-cartList");console.log(l);i();function i(){let t="";l.forEach(e=>{let s="";e.appointment.forEach((a,m)=>{s+=`<li
