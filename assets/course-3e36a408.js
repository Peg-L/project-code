import{c as le,i as j,a as x,u as C}from"./backtotop-9d7c375e.js";import{h as ce}from"./startCourse-5023c858.js";let H=document.querySelector("#js-filter-bar"),R=document.querySelector("#js-sticky-mt");const U=document.querySelector(".navbar");window.addEventListener("scroll",()=>{let t;window.innerWidth<375?t=120:window.innerWidth<768?t=300:t=418,window.scrollY<t?(H.style.boxShadow="",R.style.marginTop="",U.style.display="block"):(H.style.boxShadow="0 10px 6px -6px rgba(0, 0, 0, 0.15)",R.style.marginTop="78px",U.style.display="none")});window.addEventListener("resize",function(){(window.innerWidth||document.documentElement.clientWidth)<1200&&document.getElementById("collapseFilter").classList.add("show")});const Z=document.querySelectorAll(".js-selectedFiltersNum");let m=0;const P=document.querySelectorAll('input[name="filterStar"]'),b=document.querySelector("input[name='minPrice']"),y=document.querySelector("input[name='maxPrice']");let oe=document.querySelector("#accordionFilter");const G=document.querySelectorAll(".js-category"),ne=document.querySelector(".js-delFilterBtn");function $(){a.page=1,te(),f(a),ee()}P.forEach(t=>{t.addEventListener("change",s=>{ie(s.target.id)})});function ie(t){a.rate_gte={allStar:0,filterStar5:5,filterStar4:4,filterStar3:3,filterStar2:2,filterStar1:1}[t],$()}b.addEventListener("change",J);y.addEventListener("change",J);function J(){const t=parseInt(this.value.trim());let s,e;this===b?(s=F,e=a.price_gte):this===y&&(s=M,e=a.price_lte),isNaN(t)?e!==s&&(this===b?a.price_gte=t:this===y&&(a.price_lte=t),$()):t!==e&&(this===b?a.price_gte=t:this===y&&(a.price_lte=t),$())}let K=sessionStorage.getItem("cateItemName");K&&document.addEventListener("DOMContentLoaded",de);function de(){const t=document.querySelector(`#${K}`);if(t.checked=!0,t.classList.contains("js-selectAll")){const s=document.querySelectorAll(`input[id^="${t.name}"]:not([id="${t.name}"])`);s.length&&(s.forEach(e=>{e.checked=!0,I()}),a.page=1,f(a),ee())}else if(t.type="checkbox"){const s=t.closest(".accordion-item").querySelector(".js-selectAll"),e=t.closest(".accordion-body").querySelectorAll(".js-category");Q(s,e),I(),$()}sessionStorage.removeItem("cateItemName")}oe.addEventListener("change",t=>{const s=t.target;if(s.classList.contains("js-selectAll")){const e=s.checked,l=document.querySelectorAll(`input[id^="${s.name}"]:not([id="${s.name}"])`);l.length&&l.forEach(c=>{c.checked=e})}else if(s.type="checkbox"){const e=s.closest(".accordion-item").querySelector(".js-selectAll"),l=s.closest(".accordion-body").querySelectorAll(".js-category");Q(e,l)}I(),$()});function I(){a.filters="";let t="",s="";G.forEach(e=>{e.checked&&(e.value==="入門"||e.value==="進階"?(s=`&level_like=${e.value}`,a.filters+=s):(ue(e.value)?(t=`&categories_like=\\b${e.value}\\b`,e.value==="C"&&(t+="(?!%23)")):(t=`&categories_like=${W(e.value)}`,console.log(W(e.value)),console.dir(e)),a.filters+=t))})}function ue(t){return/^[a-zA-Z]+$/.test(t)}function W(t){return t.replace(/[!@#$%^&*()\s]/g,function(s){return encodeURIComponent(s)})}function Q(t,s){const e=[...s];t.checked=e.every(l=>l.checked)}function ee(){P[0].checked||m++,(b.value||y.value)&&m++,G.forEach(t=>{t.checked&&m++}),Z.forEach(t=>t.innerHTML=m),m=0}function fe(t){const s=document.querySelectorAll(".js-filterRatingNum"),e=document.querySelectorAll("[data-category]"),l=s.length,c=e.length,n={5:0,4:0,3:0,2:0,1:0},o={};for(let r=0;r<e.length;r++){let i=e[r].dataset.category;o[i]=0}t.forEach(r=>{const i=Math.floor(parseFloat(r.rate));if(i>=1)for(let d=1;d<=i;d++)n[d]++;r.categories.forEach(d=>{o[d]++}),o[r.level]++});for(let r=0;r<l;r++)s[r].innerHTML=`(${n[l-r]} 筆)`;for(let r=0;r<c;r++){let i=e[r].dataset.category;e[r].innerHTML=`(${o[i]})`}}ne.addEventListener("click",pe);function pe(){b.value="",y.value="",P[0].checked=!0,document.querySelectorAll(".js-selectAll, .js-category").forEach(s=>s.checked=!1),a.rate_gte=0,a.rate_lte=5,a.price_gte=F,a.price_lte=M,a.filters="",me(),$()}function me(){m=0,Z.forEach(t=>t.innerHTML=m)}function te(){window.scrollTo({top:350,left:0,behavior:"smooth"})}const se=document.querySelector(".pagination");se.addEventListener("click",t=>{const s=t.target.closest("[data-page]");if(s){t.preventDefault();const{page:e}=s.dataset;switch(e){case"prev":a.page-=1;break;case"next":a.page+=1;break;default:a.page=Number(e)}f(a),te()}});const A=document.querySelector("#courseList"),ge=/^(\d{4}-\d{2}-\d{2}).*/,z=/\B(?=(?:\d{3})+(?!\d))/g,he=le.replace("course","course_intro");A&&ce(A);function V(){const t=document.querySelectorAll("input");_?t.forEach(s=>{s.disabled=!0}):t.forEach(s=>{s.disabled=!1})}function O(){ye();let t="";_?t+=`
      ...
      </div>`,A.innerHTML=t;let s=document.querySelectorAll(".follow-btn");s&&j&&s.forEach(e=>{e.addEventListener("click",function(){e.classList.contains("following")?X(e,!0):X(e,!1)})})}function be(){const t=[...Array(N)].map((l,c)=>`<li class="page-item ${a.page===c+1?"active":""}" aria-current="page">
...
</li>`;se.innerHTML=s+t.join("")+e}let g=[];async function ye(){j?(g=(await x.get(`https://project-code-json-k0ti.onrender.com/users/${C}`)).data.followList,console.log(g)):console.log("沒有登入")}function X(t,s){let e=t.querySelector("i.fa-regular.fa-heart"),l=Number(e.dataset.buttonid);Swal.fire({title:s?"確定要取消追蹤課程?":"確定要追蹤課程?",showDenyButton:!0,confirmButtonColor:"#115BC9",confirmButtonText:s?"取消追蹤":"確認",denyButtonText:s?"我再想想":"取消"}).then(async c=>{if(c.isConfirmed)if(Swal.fire({position:"center",icon:"success",title:s?"已取消追蹤":"成功追蹤",showConfirmButton:!1,timer:1500}),t.classList.toggle("not-follow"),t.classList.toggle("following"),e.classList.toggle("fw-bold"),s){let n=g.filter(o=>o!=l);x.patch(`https://project-code-json-k0ti.onrender.com/users/${C}`,{followList:n}).then(o=>{}).catch(o=>{console.error(o)})}else g.push(l),await x.patch(`https://project-code-json-k0ti.onrender.com/users/${C}`,{followList:g})}).catch(c=>{console.error(c)})}let xe=document.querySelector(".js-totalSearchNum"),w=[],E,N;const F=0,M=9999;let a={page:1,limit:10,sort:"",order:0,q:"",rate_gte:0,rate_lte:5,price_gte:F,price_lte:M,filters:"",sort:"",order:"desc"},_=!1;$e();function $e(){const t=localStorage.getItem("indexSearchInput"),s=sessionStorage.getItem("cateItemName"),e=localStorage.getItem("redirectToPopular");console.log(e),!t&&!s&&!e&&f(a),ve(a)}async function f({page:t,limit:s,q:e,rate_gte:l,rate_lte:c,price_gte:n,price_lte:o,filters:r,sort:i,order:d}){try{const h=`https://project-code-json-k0ti.onrender.com/courses?_expand=teacher&_page=${t}&_limit=${s}&q=${e}&rate_gte=${l}&rate_lte=${c}&price_gte=${n}&price_lte=${o}${r}&_sort=${i}&_order=${d}`;_=!0,O(),V();const v=await x.get(h);w=v.data,E=parseInt(v.headers.get("X-Total-Count")),xe.innerHTML=`共 ${E} 個結果`;const S=w.map(u=>`https://project-code-json-k0ti.onrender.com/comments/${u.commentId}?_expand=user`),k=await Promise.all(S.map(u=>x.get(u)));w.forEach((u,L)=>{u.comment=k[L].data}),_=!1,O(),V(),N=Math.ceil(parseInt(E)/parseInt(a.limit)),be()}catch(h){console.log("courseError",h)}}async function ve({q:t,rate_gte:s,rate_lte:e,price_gte:l,price_lte:c,filters:n}){try{const o=`https://project-code-json-k0ti.onrender.com/courses?&q=${t}&rate_gte=${s}&rate_lte=${e}&price_gte=${l}&price_lte=${c}${n}`,r=await x.get(o);fe(r.data)}catch(o){console.log("getAllData",o)}}const Y=localStorage.getItem("indexSearchInput");Y&&(a.q=Y,f(a),a.q="",localStorage.removeItem("indexSearchInput"));const q=document.querySelector(".course-search-input");let T="";q.addEventListener("input",function(){T=q.value});const ae=document.querySelector(".course-search-button");ae.addEventListener("click",function(){a.q=T,f(a),q.value="",T=""});q.addEventListener("keyup",function(t){t.key==="Enter"&&ae.click()});const re=document.querySelector(".js-sortBy .dropdown-toggle"),we=document.querySelector(".js-sortBy .dropdown-menu"),Se=localStorage.getItem("redirectToPopular");async function ke(){if(Se){const t="commentNum";a.sort!==t&&(a.sort=t,re.innerHTML="排序依據：最熱門",a.page=1,await f(a),localStorage.removeItem("redirectToPopular"))}}ke();we.addEventListener("click",t=>{const{order:s}=t.target.dataset;s&&a.sort!==s&&(a.sort=s,re.innerHTML=`排序依據：${t.target.textContent}`,a.page=1,f(a))});
