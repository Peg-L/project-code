import{a as p,u as L,g as k,r as A}from"./backtotop-257d1cbf.js";let r=[];const _=Swal.mixin({toast:!0,position:"top-end",showConfirmButton:!1,timer:2e3}),b=document.querySelector("#coupon"),P=document.querySelector(".js-useCouponBtn");let h=[],y=[];const W={myCouponId:"",originPrice:"",courseId:"",type:"",title:"",discount:0,minSpending:"",discountCourseNum:"",discountPrice:0};function w(){r=Array.from({length:l.length+1},()=>W)}b.addEventListener("keydown",t=>{t.key==="Enter"&&(t.preventDefault(),q())});P.addEventListener("click",t=>{t.preventDefault(),q()});async function Q(){try{for(const t of r)if(t.myCouponId){const e=`http://localhost:3000/myCoupons/${t.myCouponId}`,n={canUse:!1};await p.patch(e,n,headers)}}catch(t){console.log("patchMyCoupon",t)}}async function R(){try{const t=`http://localhost:3000/myCoupons?_expand=coupon&userId=${L}&_sort=couponId&_order=asc`,{data:e}=await p.get(t);if(e.length){const n=e.map(s=>`http://localhost:3000/coupons/${s.couponId}?_expand=teacher&_expand=course`),o=await Promise.all(n.map(s=>p.get(s)));e.forEach((s,c)=>{s.coupon=o[c].data})}h=e,V()}catch(t){console.log("getCoupon",t)}}async function V(){const t=[];h.forEach(e=>{let n=new Date().getTime();new Date(e.dueDate).getTime()<n&&(e.canUse=!1,t.push(e))}),t.length>0&&(await Promise.all(t.map(async e=>{try{await p.patch(`http://localhost:3000/myCoupons/${e.id}`,{canUse:!1},headers)}catch(n){console.log("checkDueDate",n)}})),h=h.filter(e=>e.canUse===!0)),B()}function B(){y=[],h.forEach(t=>{if(t.coupon.type==="allCourse"){const{courseId:e,type:n,title:o,minSpending:s,discountCourseNum:c,discount:a}=t.coupon,i={myCouponId:t.id,originPrice:null,courseId:e,type:n,title:o,discount:a,minSpending:s,discountCourseNum:c};y.push(i)}}),l.forEach(t=>{h.forEach(e=>{if(e.coupon.type==="course"){const{courseId:n,type:o,title:s,discount:c,minSpending:a,discountCourseNum:i}=e.coupon,{price:u}=e.coupon.course;if(n==t.courseId){const d={myCouponId:e.id,originPrice:u,courseId:n,type:o,title:s,discount:c,minSpending:a,discountCourseNum:i};y.push(d)}}})}),X()}function q(){const t=y.filter(e=>e.title===b.value)[0];if(t!==void 0){const e=document.querySelector("#OriginalPrice").textContent.replace(",",""),n=document.querySelectorAll("li[data-course]"),{minSpending:o,discountCourseNum:s,courseId:c}=t;if(_.fire({icon:"success",title:"已使用優惠券"}),o<=e)if(t.type==="course")n.forEach((a,i)=>{const u=a.dataset.course;if(c==u){const d=a.querySelector("input[name='count']");s===""||s<=d.value?r[i].myCouponId==""?(b.value="",j(i,t)):Swal.fire({icon:"error",title:"每個課程只能使用一張優惠券"}):Swal.fire({icon:"error",title:"未符合使用條件",text:`須購買指定課程達 ${s} 堂課`})}});else{const a=r.length-1;r[a].myCouponId==""?(b.value="",j(a,t)):Swal.fire({icon:"error",title:"每個課程只能使用一張優惠券"})}else Swal.fire({icon:"error",title:"未符合使用條件",text:`折價前的消費總額須達 NT$ ${o}`})}else Swal.fire({icon:"error",title:"沒有匹配的優惠券"})}function z(t){v(t),C()}function F(t,e){const n=document.querySelector("#OriginalPrice").textContent.replace(",","");r.forEach((o,s)=>{const{minSpending:c,discountCourseNum:a,courseId:i,myCouponId:u}=o;c<=n?i==t?a===""||a<=e?o.discountPrice=S(o):v(s):s==r.length-1&&u!==""?o.discountPrice=S(o):v(s):v(s)}),C()}function v(t){r[t].type="",r[t].originPrice=0,r[t].discountPrice=0,r[t].title="",r[t].myCouponId="",r[t].courseId="",r[t].discount="",r[t].minSpending=0,r[t].discountCourseNum=0}function j(t,e){r[t]={...e,discountPrice:S(e)},C()}function S(t){const{type:e,originPrice:n,discount:o,discountCourseNum:s}=t;if(e==="course")return Math.round(Number(n)*(1-Number(o))*Number(s));{const c=document.querySelector("#OriginalPrice").textContent.replace(",","");return Math.round(Number(c)*(1-Number(o)))}}function E(t){r=r.filter(e=>e.courseId!=t)}const O=document.querySelector(".js-cartList"),G=document.querySelector(".js-nextCartList");function N(){let t="";l.length?l.forEach((e,n)=>{var o,s,c,a,i,u,d,m;t+=`
      ...
      `,O.innerHTML=t,J()}function J(){const t=document.querySelector("#payWay");l.length?(t.querySelectorAll("button").forEach(e=>{e.disabled=!1}),P.disabled=!1):(t.querySelectorAll("button").forEach(e=>{e.disabled=!0}),P.disabled=!0)}function M(){let t="";f.length?f.forEach((e,n)=>{var o,s,c,a,i,u,d,m;t+=`
      <li data-course="${e.courseId}">
              <div
                class="shadow rounded-2 p-4 pb-md-4 pt-md-6 px-md-8 mb-1 mb-md-2"
              >
      ...
      <div class="d-flex justify-content-center py-10">
        ...
        </p>`})}function te(t){const e=t.getAttribute("data-bs-target"),n=document.querySelector(e),o=document.querySelector("#TotalPrice").innerText;let s=new Date;s.setDate(s.getDate()+5),s=s.toISOString(),n.querySelector(".js-paymentPrice").innerHTML=`NT$ ${o}`,n.querySelector(".js-dueDate").innerHTML=`${H.exec(s)[1]} 23:59:59`}const H=/^(\d{4}-\d{2}-\d{2}).*/,x=/\B(?=(?:\d{3})+(?!\d))/g,ne=document.querySelector("#purchaseTabContent");document.querySelector("#mainPurchase");const I={headers:{"Content-Type":"application/json"}};let l=[],f=[];oe();async function oe(){K(),await se(),N(),l.length&&(g(),w(),R()),M()}async function se(){try{const t=`http://localhost:3000/myCarts?userId=${L}&status=purchase&_expand=course`,{data:e}=await p.get(t);if(e!==void 0){const n=e.map(s=>`http://localhost:3000/courses/${s.courseId}?_expand=teacher`),o=await Promise.all(n.map(s=>p.get(s)));e.forEach((s,c)=>{s.course=o[c].data}),re(e)}}catch(t){console.log("getMyCart",t)}}function re(t){let e=new Date;e.setDate(e.getDate()+365),e.setHours(23,59,59,999),e=H.exec(e.toISOString())[1],t.forEach(n=>{n.dueDate=e}),l=t.filter(n=>!n.isNextPurchase),f=t.filter(n=>n.isNextPurchase)}document.addEventListener("DOMContentLoaded",()=>{ne.addEventListener("click",t=>{const e=t.target,n=e.closest("li");if(n){t.preventDefault();const o=n.dataset.course,s=n.querySelector("input[name='count']");if(e.classList.contains("delete-order"))ce(o);else if(e.classList.contains("js-nextPurchaseBtn"))ie(o);else if(e.classList.contains("js-mainPurchaseBtn"))ue(o);else if(e.classList.contains("js-increment"))pe(o,s);else if(e.classList.contains("js-decrement"))fe(o,s);else if(e.classList.contains("js-delCoupon")){const c=e.dataset.index;z(c)}}})});function ce(t){Swal.fire({title:"確定要刪除嗎?",showDenyButton:!0,confirmButtonColor:"#115BC9",confirmButtonText:"確定刪除",denyButtonText:"我再想想"}).then(async e=>{e.isConfirmed&&(Swal.fire({position:"center",icon:"success",title:"已刪除課程",showConfirmButton:!1,timer:1500}),ae(t),E(t),w(),C(),g())})}async function ae(t){try{let e;l=l.filter(n=>(n.courseId==t&&(e=n.id),n.courseId!=t)),f=f.filter(n=>(n.courseId==t&&(e=n.id),n.courseId!=t)),D(),await p.patch(`http://localhost:3000/myCarts/${e}`,{userId:"",courseId:"",quantity:""},I)}catch(e){console.log("deleteCart",e)}}async function ie(t){(await Swal.fire({title:"確定要下次再買該課程嗎?",showDenyButton:!0,confirmButtonColor:"#115BC9",confirmButtonText:"確定",denyButtonText:"我再想想"})).isConfirmed&&(Swal.fire({position:"center",icon:"success",title:"已移至下次再買",showConfirmButton:!1,timer:1500}),le(t),E(t),w(),C(),g())}async function le(t){try{let e;l=l.filter(n=>(n.courseId==t&&(e=n.id,f.push(n)),n.courseId!=t)),D(),await p.patch(`http://localhost:3000/myCarts/${e}`,{isNextPurchase:!0},I)}catch(e){console.log("toNextPurchase",e)}}function ue(t){Swal.fire({title:"確定將該課程移至購物車嗎?",showDenyButton:!0,confirmButtonColor:"#115BC9",confirmButtonText:"確定",denyButtonText:"我再想想"}).then(e=>{e.isConfirmed&&(Swal.fire({position:"center",icon:"success",title:"已移置購買項目",showConfirmButton:!1,timer:1500}),de(t),w(),C(),g())})}async function de(t){try{let e;f=f.filter(n=>(n.courseId==t&&(e=n.id,l.push(n)),n.courseId!=t)),D(),await p.patch(`http://localhost:3000/myCarts/${e}`,{isNextPurchase:!1},I)}catch(e){console.log("toMainPurchase",e)}}async function D(){N(),l.length&&B(),M(),await k(),A()}function pe(t,e){$(e).val(function(n,o){return parseInt(o)+1}),T(t,e.value)}function fe(t,e){$(e).val(function(n,o){return parseInt(o)===1?1:parseInt(o)-1}),T(t,e.value)}document.addEventListener("change",t=>{t.target.name==="count"&&U(t.target)});document.addEventListener("keydown",t=>{t.target.name==="count"&&t.key==="Enter"&&(t.preventDefault(),U(t.target))});function U(t){const e=t.closest("[data-course]").dataset.course;t.value.match(/[^0-9]|^0$/g)&&(t.value=t.defaultValue),T(e,t.value)}function T(t,e){me(t,e),F(t,e),g()}function me(t,e){let n;l.forEach(o=>{o.courseId==t&&(n=o.id,o.quantity=e)}),he(n,e)}async function he(t,e){try{const n=`http://localhost:3000/myCarts/${t}`,o={quantity:e};await p.patch(n,o,I)}catch{}}function g(){const t=$(".order");let e=0;t.each(function(){const a=$(this),i=parseInt(a.find('[name="count"]').val()),u=a.find(".OriginalCoursePrice").text().replace(",",""),d=parseInt(u),m=i*d;e+=m}),$("#OriginalPrice").text(e.toString().replace(x,","));const o=parseInt($("#CourseDiscount").text().replace(",","")),s=parseInt($("#WebDiscount").text().replace(",","")),c=e-o-s;$("#TotalPrice").text(c.toString().replace(x,","))}const ye=document.querySelectorAll(".js-paymentInfoBtn"),Ce=document.querySelectorAll(".js-payBtn");ye.forEach(t=>{t.addEventListener("click",e=>te(e.target))});Ce.forEach(t=>{t.addEventListener("click",async e=>{e.preventDefault(),await Q(),await ge(),location.href="cart2.html"})});async function ge(){try{const t=myCarts.map(e=>`http://localhost:3000/myCarts/${e.id}`);await Promise.all(t.map((e,n)=>{const o={status:"appointment",dueDate:myCarts[n].dueDate};return axios.patch(e,o,headers)}))}catch{}}
