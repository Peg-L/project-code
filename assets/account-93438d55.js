import{a as p,u as b,c as X,i as he}from"./backtotop-f8562c14.js";import"./openTime-482ad5b4.js";import{h as fe}from"./startCourse-eb5bf10a.js";let M=[];const ge=document.querySelector("#userName"),be=document.querySelector("#userRole"),ve=document.querySelector("#userImg"),$e=document.querySelector("#PreviousWeek"),ye=document.querySelector("#NextWeek"),oe=document.querySelector("#courseTeacherName"),ae=document.querySelector("#courseName"),se=document.querySelector("#dateTime");function xe(){p.get(`https://project-code-json-k0ti.onrender.com/user_courses?_expand=user&userId=${b.toString()}`).then(function(e){M=e.data[0],ve.setAttribute("src",M.user.avatar),ge.textContent=M.user.name,be.textContent=M.user.role,V()})}function V(){document.querySelectorAll(".calendar-time").forEach(i=>{let o=i.getAttribute("data-num"),a=n(o),s="";if(a.length!==0)for(let c=0;c<a.length;c++)s+=`<li class="c2"><a href=''
  ...
  </div></div>`}),Y.innerHTML=a,t(),n(),r()}else a='<p class="text-center fs-5">目前沒有追蹤任何課程</p>',Y.innerHTML=a,t()}catch(o){console.log("錯誤",o)}}e();function t(){const o=document.querySelector(".followPagination");let a="";if(_){const s=`<li class="page-item prevButton ${x==1?"disabled":""}"><a class="page-link" href="#" aria-label="Previous"><i class="fa-solid fa-angle-left"></i></a></li>`;a+=s;for(let u=1;u<=_;u++){let d=`<li class="page-item ${u===x?"active":""} pageButton">
