import"./backtotop-948c3cb8.js";import{a as g}from"./axios-21b846bc.js";const p=document.querySelectorAll("#change"),y=document.querySelectorAll("#saveBtn"),h=document.querySelectorAll("#btnBlock"),b=document.querySelectorAll("#date"),m=document.querySelectorAll("#time");p.forEach((a,t)=>{a.addEventListener("click",f=>{b[t].toggleAttribute("disabled"),m[t].toggleAttribute("disabled"),h[t].classList.toggle("hidden"),a.toggleAttribute("disabled")})});y.forEach((a,t)=>{a.addEventListener("click",f=>{b[t].toggleAttribute("disabled"),m[t].toggleAttribute("disabled"),h[t].classList.toggle("hidden"),p[t].toggleAttribute("disabled")})});let n=1,r=[],d=0,u=[];document.addEventListener("DOMContentLoaded",async function(){async function a(){try{r=(await g.get(`${_url}/users/${userId}`)).data.followList,d=Math.ceil(r.length/6);let e="";if(r.length!=0){let o=`${_url}/courses?_expand=teacher&_page=${n}&_limit=6`;r.forEach(l=>{o+=`&id=${l}`}),u=(await g.get(`${o}`)).data,console.log("追蹤的課程資料",u);const i=document.querySelector("#followList");u.forEach(l=>{e+=`<div class="col"><div class="card teacher-card swiper-slide h-100"><button
  ...
  </div></div>`}),i.innerHTML=e,t(),f(),w()}else e='<p class="text-center fs-5">目前沒有追蹤任何課程</p>'}catch(s){console.log("錯誤",s)}}a();function t(){const s=document.querySelector(".followPagination");let e="";if(d){const o=`<li class="page-item prevButton ${n==1?"disabled":""}"><a class="page-link" href="#" aria-label="Previous"><i class="fa-solid fa-angle-left"></i></a></li>`;e+=o;for(let i=1;i<=d;i++){let l=`<li class="page-item ${i===n?"active":""} pageButton">
