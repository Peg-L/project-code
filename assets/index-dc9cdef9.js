import{c as r,a as o,i as u}from"./backtotop-257d1cbf.js";import{h as p}from"./startCourse-477ed2b7.js";new Swiper(".bannerSwiper",{slidesPerView:1,loop:!0,pagination:{el:".bannerSwiper-pagination",clickable:!0}});let n;const m=document.querySelectorAll(".banner-btn-search"),w=document.querySelectorAll(".banner-input");w.forEach(e=>{e.addEventListener("input",()=>{n=e.value,m.forEach(s=>{s.addEventListener("click",()=>{localStorage.setItem("indexSearchInput",n),e.value="",location.href="./course.html"}),document.addEventListener("keyup",function(i){i.key==="Enter"&&s.click()})})})});const l=/\/[^/]+\.html/,h=l.test(r)?r.replace(l,"/course_intro.html"):r+"course_intro.html";o.get("http://localhost:3000/courses?_expand=teacher").then(e=>{let a=e.data.filter(t=>t.badges.includes("熱門")).slice(0,7),c="";const d=document.querySelector(".recommend-swiper");a.forEach(t=>{c+=`<div class="card teacher-card swiper-slide">
